<form action="" method="post">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2"><?php echo Tr::t('admin', 'Create Language')?></h1>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" name="Language[code]" id="code" required>
        </div>
    </div>
    <div class="form-group row">
        <label for="name" class="col-sm-2 col-form-label"><?php echo Tr::t('admin', 'Name')?></label>
        <div class="col-sm-10">
            <input type="text" class="form-control" name="Language[name]" id="name" required>
        </div>
    </div>
    <div class="form-group row">
        <label for="title" class="col-sm-2 col-form-label"><?php echo Tr::t('admin', 'Title')?></label>
        <div class="col-sm-10">
            <input type="text" class="form-control" name="Language[title]" id="title" required>
        </div>
    </div>
    <div class="form-group row">
        <label for="locale" class="col-sm-2 col-form-label"><?php echo Tr::t('admin', 'Locale')?></label>
        <div class="col-sm-10">
            <input type="text" class="form-control" name="Language[locale]" id="locale" required>
        </div>
    </div>
    <div class="form-group row">
